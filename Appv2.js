...
function Square({ value }) {
  ...
  if(value != "."){return (<button className="square">{value}</button>);}
  else{return (<input type = "text" className="emptySquare" onChange = {handleChange}/>);}
}
...
export default function Board() {
  let pzlArray = [];
  const [pzlString, setPzlString] = useState("......9.7...42.18....7.5.261..9.4....5.....4....5.7..992.1.8....34.59...5.7......");
  ...
  return (<>
    <div id = "board">
      <div id = "verticalOne"></div> {/*box borders*/}
      <div id = "verticalTwo"></div>
      <div id = "horizontalOne"></div>
      <div id = "horizontalTwo"></div>
      <div id = "leftBorder"></div>
      <div id = "topBorder"></div>
      <div id = "bottomBorder"></div>
      <div id = "rightBorder"></div>
    <div className="board-row">
    <Square value={squares[0]}/><Square value={squares[1]} /><Square value={squares[2]} /><Square value={squares[3]} /><Square value={squares[4]} />
      <Square value={squares[5]} /><Square value={squares[6]} /><Square value={squares[7]} /><Square value={squares[8]} />
    </div>
    <div className="board-row">
      <Square value={squares[9]} /><Square value={squares[10]} /><Square value={squares[11]} /><Square value={squares[12]} /><Square value={squares[13]} />
      <Square value={squares[14]} /><Square value={squares[15]} /><Square value={squares[16]} /><Square value={squares[17]} />
    </div>
    <div className="board-row">
      <Square value={squares[18]} /><Square value={squares[19]} /><Square value={squares[20]} /><Square value={squares[21]} /><Square value={squares[22]} />
      <Square value={squares[23]} /><Square value={squares[24]} /><Square value={squares[25]} /><Square value={squares[26]} />
    </div>
    <div className="board-row">
      <Square value={squares[27]} /><Square value={squares[28]} /><Square value={squares[29]} /><Square value={squares[30]} /><Square value={squares[31]} />
      <Square value={squares[32]} /><Square value={squares[33]} /><Square value={squares[34]} /><Square value={squares[35]} />
    </div>
    <div className="board-row">
      <Square value={squares[36]} /><Square value={squares[37]} /><Square value={squares[38]} /><Square value={squares[39]} /><Square value={squares[40]} />
      <Square value={squares[41]} /><Square value={squares[42]} /><Square value={squares[43]} /><Square value={squares[44]} />
    </div>
    <div className="board-row">
      <Square value={squares[45]} /><Square value={squares[46]} /><Square value={squares[47]} /><Square value={squares[48]} /><Square value={squares[49]} />
      <Square value={squares[50]} /><Square value={squares[51]} /><Square value={squares[52]} /><Square value={squares[53]} />
    </div>
    <div className="board-row">
      <Square value={squares[54]} /><Square value={squares[55]} /><Square value={squares[56]} /><Square value={squares[57]} /><Square value={squares[58]} />
      <Square value={squares[59]} /><Square value={squares[60]} /><Square value={squares[61]} /><Square value={squares[62]} />
    </div>
    <div className="board-row">
      <Square value={squares[63]} /><Square value={squares[64]} /><Square value={squares[65]} /><Square value={squares[66]} /><Square value={squares[67]} />
      <Square value={squares[68]} /><Square value={squares[69]} /><Square value={squares[70]} /><Square value={squares[71]} />
    </div>
    <div className="board-row">
      <Square value={squares[72]} /><Square value={squares[73]} /><Square value={squares[74]} /><Square value={squares[75]} /><Square value={squares[76]} />
      <Square value={squares[77]} /><Square value={squares[78]} /><Square value={squares[79]} /><Square value={squares[80]} />
    </div>
    </div>
    <div id = "buttons">
